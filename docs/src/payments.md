...
```python
token_data = tokenize_card_e3c7ed("1234567890123456", 12, 2025, "90210")
print(token_data)
# Output: {'token': 'tok_3456_...', 'last4': '3456', 'expiry': '12/2025', 'billing_zip': '90210', 'network': 'unknown'}
```
```