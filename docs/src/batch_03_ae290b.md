```markdown
### `process_batch_payment_03_ae290b`
...
unit_amount = 100.0
result = process_batch_payment_03_ae290b(order_ids, unit_amount)
print(result)
...
#     'total_net': 291.0,
#     'orders': [
#         {'order_id': 'order123', 'gross': 100.0, 'discount': 3.0, 'net': 97.0},
#         {'order_id': 'order456', 'gross': 100.0, 'discount': 3.0, 'net': 97.0},
#         {'order_id': 'order789', 'gross': 100.0, 'discount': 3.0, 'net': 97.0}
#     ]
# }
```
```