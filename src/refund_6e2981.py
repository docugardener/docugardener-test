"""Refund service module — 6e2981.

Provides issue_refund_6e2981 for processing order refunds.
"""


def issue_refund_6e2981(order_id: str, amount: float, reason: str) -> dict:
