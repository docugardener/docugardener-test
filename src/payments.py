...
"""Refund service module — f9374d.

Provides issue_refund_f9374d for processing order refunds.
"""


def issue_refund_f9374d(order_id: str, amount: float, reason: str) -> dict:
    """Issue a refund for a completed order.
