"""Refund service module — a9330c.

Provides issue_refund_a9330c for processing order refunds.
"""


def issue_refund_a9330c(order_id: str, amount: float, reason: str) -> dict:
